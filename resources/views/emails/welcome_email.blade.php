...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Welcome to PRDP-HRMS! Your account has been successfully created. Below are your login credentials.</p>

            <div class="password-box">
                <strong>Employee Number:</strong> {{ $user->employee_number }}<br>
