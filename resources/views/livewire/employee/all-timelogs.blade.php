    ...
    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-700 p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <input type="text" wire:model.live="search" placeholder="Name or Employee ID"
                ...
                <tbody x-data="{ open: {} }" class="divide-y divide-gray-200 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-700/50 transition-colors">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    @if($timelog->user->employee && $timelog->user->employee->unit)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                        {{ $timelog->user->employee->unit->code }}
                                    </span>
                                    @else
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                        @if($timelog->user->employee && $timelog->user->employee->office)
                                        {{ $timelog->user->employee->office->code }}
                                        @else
                                        No Office
                                        @endif
                                    </span>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <button @click="open[{{ $timelog->id }}] = !open[{{ $timelog->id }}]"
                    ...
                    <tr x-show="open[{{ $timelog->id }}]" x-transition class="bg-gray-50 dark:bg-zinc-700/30">
                        <td colspan="8" class="px-6 py-5">
                            <div
                                class="w-full space-y-2 text-sm text-gray-800 dark:text-zinc-300 leading-relaxed">
                                <h3
