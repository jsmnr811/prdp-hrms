<div class="w-full max-w-6xl mx-auto bg-white dark:bg-zinc-900">
        ...
        <div class="text-center space-y-4">
            ...
            <flux:avatar src="{{ asset('storage/' . $this->employee->image) }}" alt="Profile" size="xl" class="mx-auto shadow-lg ring-4 ring-white dark:ring-zinc-800" />
            @endif
            <flux:heading size="xl" class="font-semibold tracking-tight text-slate-900 dark:text-white">
                Update Profile
            </flux:heading>
        ...
        <div class="flex flex-col md:flex-row gap-4 md:gap-0">
            ...
            <div class="w-full md:w-1/5 pr-0 md:pr-6 border-r-0 md:border-r border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-zinc-900 rounded-lg p-4 shadow-sm">
                <nav class="flex flex-col space-y-2" aria-label="Tabs">
                    ...
                    <button
                        ...
                        class="{{ $activeTab === 'personal'
                            ? 'border-blue-500 text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/20 shadow-sm'
                    ...
                    <button
                        wire:click="$set('activeTab', 'organizational')"
                        type="button"
            ...
            <flux:card x-show="$wire.activeTab === 'personal'" x-transition.opacity.duration.300ms class="space-y-6 p-8 bg-white dark:bg-zinc-900 shadow-xl rounded-xl border border-slate-200 dark:border-slate-700">
                {{-- Success Message --}}
                ...
                <form wire:submit.prevent="updatePersonal" class="space-y-6">
                    <div class="space-y-4">
                        <flux:heading size="md" class="font-semibold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-600 pb-2">
                            Personal Information
                        </flux:heading>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="first_name" type="text" placeholder="Enter first name" class="h-11" />
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="last_name" type="text" placeholder="Enter last name" class="h-11" />
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="middle_name" type="text" placeholder="Enter middle name (optional)" class="h-11" />
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="suffix" type="text" placeholder="e.g., Jr., Sr., III" class="h-11" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <flux:field>
                                ...
                                <x-select-dropdown wire:model="gender" placeholder="Select Gender" :options="$genderOptions" class="h-11" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="tin" type="text" placeholder="Enter TIN" class="h-11" />
                                <flux:error name="tin" />
                            </flux:field>
                            ...
                            <flux:field>
                                ...
                                <x-select-dropdown wire:model="blood_type" placeholder="Select Blood Type" :options="$bloodTypeOptions" class="h-11" />
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="landbank_account" type="text" placeholder="Enter account number" class="h-11" />
                        ...
                        <flux:field>
                            ...
                            @if ($image)
                            <div class="mt-6">
                                <p class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">New Image Preview:</p>
                                <div class="flex justify-center">
                                    <img src="{{ $image->temporaryUrl() }}" alt="Image Preview"
                                        class="h-40 w-40 object-cover rounded-xl border-4 border-blue-200 dark:border-blue-600 shadow-lg" />
                                </div>
                            </div>
                            @elseif ($this->employee->image)
                            <div class="mt-6">
                                <p class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">Current Image:</p>
                                <div class="flex justify-center">
                                    <img src="{{ asset('storage/' . $this->employee->image) }}" alt="Current Image"
                                        class="h-40 w-40 object-cover rounded-xl border-4 border-slate-200 dark:border-slate-600 shadow-lg" />
                                </div>
                            </div>
                            @endif
                        </flux:field>
            ...
            <flux:card x-show="$wire.activeTab === 'contact'" x-transition.opacity.duration.300ms style="display: none;" class="space-y-6 p-8 bg-white dark:bg-zinc-900 shadow-xl rounded-xl border border-slate-200 dark:border-slate-700">
                {{-- Success Message --}}
                ...
                <form wire:submit.prevent="updateContact" class="space-y-6">
                    <div class="space-y-4">
                        <flux:heading size="md" class="font-semibold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-600 pb-2">
                            Contact Information
                        </flux:heading>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="contact_number" type="text" placeholder="e.g., 09123456789" class="h-11">
                                    <x-slot name="iconLeading">
                                        <flux:icon.phone variant="mini" />
                                    </x-slot>
                                </flux:input>
                        ...
                        <flux:field>
                            ...
                            <flux:textarea wire:model="address" placeholder="Enter complete address" rows="3" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="emergency_contact_name" type="text" placeholder="Full name" class="h-11">
                                    <x-slot name="iconLeading">
                                        <flux:icon.user variant="mini" />
                                    </x-slot>
                                </flux:input>
                            ...
                            <flux:field>
                                ...
                                <x-select-dropdown wire:model="emergency_contact_relationship" placeholder="Select Relationship" :options="$relationshipOptions" class="h-11" />
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model="emergency_contact_number" type="text" placeholder="e.g., 09123456789" class="h-11">
                                    <x-slot name="iconLeading">
                                        <flux:icon.phone variant="mini" />
                                    </x-slot>
                                </flux:input>
            ...
            <flux:card x-show="$wire.activeTab === 'organizational'" x-transition.opacity.duration.300ms style="display: none;" class="space-y-6 p-8 bg-white dark:bg-zinc-900 shadow-xl rounded-xl border border-slate-200 dark:border-slate-700">
                {{-- Success Message --}}
                ...
                <form wire:submit.prevent="updateOrganizational" class="space-y-6">
                    <div class="space-y-4">
                        <flux:heading size="md" class="font-semibold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-600 pb-2">
                            Organizational Information
                        </flux:heading>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <flux:field>
                                ...
                                {{-- Loading indicator --}}
                                <div wire:loading wire:target="office_id" class="text-xs text-blue-500 dark:text-blue-400 mt-1">
                                    Loading units...
                                </div>
            ...
            {{-- Password Tab Panel --}}
            <flux:card x-show="$wire.activeTab === 'password'" x-transition.opacity.duration.300ms style="display: none;" class="space-y-6 p-8 bg-white dark:bg-zinc-900 shadow-xl rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <form wire:submit.prevent="changePassword" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {{-- Current Password --}}
                        <flux:field>
                            <flux:label class="text-sm font-medium">Current Password</flux:label>
                            <flux:input wire:model="current_password" type="password" placeholder="Enter current password" class="h-11" />
                            <flux:error name="current_password" />
                        </flux:field>

                        {{-- New Password --}}
                        <flux:field>
                            <flux:label class="text-sm font-medium">New Password</flux:label>
                            <flux:input wire:model="new_password" type="password" placeholder="Enter new password" class="h-11" />
                            <flux:error name="new_password" />
                        </flux:field>

                        {{-- Confirm Password --}}
                        <flux:field>
                            <flux:label class="text-sm font-medium">Confirm New Password</flux:label>
                            <flux:input wire:model="confirm_password" type="password" placeholder="Confirm new password" class="h-11" />
