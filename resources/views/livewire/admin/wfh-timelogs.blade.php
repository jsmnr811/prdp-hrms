<div>
    ...
    <flux:breadcrumbs>
        <flux:breadcrumbs.item href="{{ route('wfh-timelogs') }}">WFH Timelogs</flux:breadcrumbs.item>
    </flux:breadcrumbs>
                                ...
                                <div>
                                    <div class="relative">
                                        <input type="file" wire:model="selfie"
                                            accept="image/jpeg,image/jpg,image/png" class="hidden" id="selfie-upload"
                                            ...
                                            @else
                                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                    ...
                                                    <p class="mb-2 text-sm text-gray-500 dark:text-zinc-400"><span
                                                        ...
                                                        drop</p>
                                                    <p class="text-xs text-gray-500 dark:text-zinc-400">JPG, JPEG or
                                                        PNG
                                                    </p>
                                                </div>
                                            @endif
